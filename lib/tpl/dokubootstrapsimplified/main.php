        	...
        	<div class="row">
				...
				<?php } ?>
                	<div class="page">
						...
						<!--  järgnev div on trüki pdf nupu wrapper -->
						<div class='printout_button'>
						<form class="button" method="get" action="<?php wl($ID)?>">
						  <div class="no">
								<!-- asendan tekstinupu pildiga-->
								<button type="submit" style="border: 0; background: transparent">
									<img src="/docuwiki/lib/tpl/dokubootstrapsimplified/images/printout.png" width="24" height="24" alt="submit" />
								</button>
